...
public class CategoriaResource {
	...
	public ResponseEntity<List<CategoriaDTO>> findAll() throws ObjectNotFoundException{
		...
		List<CategoriaDTO> listDTO = list.stream().map(//aqui faz a conversão "mapeamento"
	...
	public ResponseEntity<Page<CategoriaDTO>> findPage(
		...
		Page<CategoriaDTO> listDTO = list.map(//Page não precisa do stream pois já é java 8
